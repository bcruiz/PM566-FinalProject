...
incidence_rate <- plot_usmap(data = map_merge, values='rate', include = 'CA')+
  scale_fill_continuous(low = 'white', high = 'red', name = 'Prevalence Rate')+
  labs(title = 'Prevalence Rate of Covid Cases',
       caption = paste('As of ', as.Date(max(mapdf$Date))))+
  theme(plot.title = element_text(hjust = 0.5, vjust = 0.25, size = 18), legend.position = "right",
        legend.title = element_text(size = 14), legend.text = element_text(size = 12))
