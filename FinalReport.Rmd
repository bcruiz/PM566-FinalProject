...
ggplot(covidGithubmelt, aes(Date, new_cases, color = county))+
  ...
  labs(title = 'Incidences of Covid Cases in California by County', y = 'New Cases')+
...
# ggplot(cvd_pop, aes(TOT_POP, Confirmed, color = county, size = TOT_POP))+
#   geom_point()

# Could mention plot from website
```
...
```{r AQI Visual, message=FALSE, warning=FALSE, eval=FALSE}
